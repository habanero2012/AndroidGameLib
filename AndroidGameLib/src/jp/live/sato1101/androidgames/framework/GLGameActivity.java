...
public abstract class GLGameActivity extends Activity implements GLGame, Renderer{
	enum GLGameState {
		Initialized,
		Running,
		Paused,
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		int widthRatio = r.getInteger(R.integer.width_ratio);
		int heightRatio = r.getInteger(R.integer.height_ratio);
		
		while(Global.surfaceWidth < width && Global.surfaceHeight < height) {
			Global.surfaceWidth += widthRatio;
